...
def read_options():
    ...
    parser.add_argument('--algo',
                        ...
                        type=str,
                        choices=OPTIMIZERS,
                        default='FedVARP')#FedVARP  fdu_no_wait  MIFA  fedavg  sgd fdu_not_1round
    ...
    parser.add_argument('--dataset',
                        ...
                        type=str,
                        default='cifar_all') #mnist  cifar_all  svhn
    ...
    parser.add_argument('--model',
                        help='name of model;',
                        type=str,
                        default='lenet3')  #logistic lenet3  resnet18
...
def main():
    ...
    trainer.train()
    # trainer.train_last(options['model'],options['algo'], options['client_number'],options['result_dir'])
    trainer.train_last(options['model'], options['algo'], options['client_number'], options['result_dir'])
    trainer.test_last(options['model'],options['algo'], options['client_number'],options['result_dir'])
